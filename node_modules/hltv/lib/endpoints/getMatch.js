        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    streams = mappers_1.toArray($('.stream-box-embed')).filter(E.hasChild('.flagAlign')).map(function (streamEl) { return ({
                    ...
                    return [2, {
                            ...
                            title: title, hasScorebot: hasScorebot, highlightedPlayer: highlightedPlayer, headToHead: headToHead, vetoes: vetoes, highlights: highlights, demos: demos
                        }];
            }
        });
    });
